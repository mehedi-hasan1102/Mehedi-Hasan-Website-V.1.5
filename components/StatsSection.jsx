...
// const stats = [
//   { icon: <Ruler className="w-10 h-10 text-primary" />, number: "20+", label: "Hands-On Projects" },
//   { icon: <Monitor className="w-10 h-10 text-primary" />, number: "35+", label: "Projects Completed" },
//   { icon: <Code className="w-10 h-10 text-primary" />, number: "1", label: "Full-Stack Tech Stack" },
//   { icon: <Clock className="w-10 h-10 text-primary" />, number: "500+", label: "Hours of Coding & Learning" },
// ];
...
//                   ...prev,
//                   [idx]: Date.now(), // change key to re-render CountUp
//                 }));
//               }}
